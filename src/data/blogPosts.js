export const blogPosts = [
    ...
    },
    {
        ...
        readTime: '10 min read',
        content: {
            introduction: 'Every developer has had that moment: you\'ve shipped a feature, the CI pipeline explodes with linting errors, and you spend the next two days untangling messes that a smarter scaffolding decision could have prevented. That exact experience—building a feature inside Antigravity IDE and watching a cascade of linting issues tear through the codebase—is what sparked SkillDeck. IDEs like Antigravity, RubyMine, and Cursor all support skills or rules to guide AI behaviour, but the experience is ambiguous: it\'s never obvious which skills to activate, how to configure them, or whether they\'ll travel with your project. That ambiguity means developers skip them entirely—and the AI hallucinates, confidently producing code that looks right but violates every convention your team cares about. The idea is simple but powerful: what if you could load up an AI agent\'s skills the way you load a Ruby gem, selecting precisely the guardrails and expertise your project needs before a single line of code is written?',
            sections: [
                {
