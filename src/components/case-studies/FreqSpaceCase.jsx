            ...
            <section className={`pt-32 pb-20 px-6 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="max-w-4xl mx-auto">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <span className="text-xs px-2 py-1 rounded-full bg-amber-50 text-amber-600" style={{ fontFamily: 'system-ui, sans-serif' }}>
                            In Development
                        </span>
                    </div>
                    
                    <h1 className="text-5xl md:text-7xl font-normal mb-6">
                        <span className="text-stone-900">freq</span>
                        <span className="italic text-blue-500">.space</span>
                    </h1>
                            ...
                            <div key={index} className="border-t border-stone-200 pt-8">
                                <div className="flex gap-6">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-stone-600 leading-relaxed" style={{ fontFamily: 'system-ui, sans-serif' }}>
                                            {step.description}
                                        </p>
                                    </div>
                                </div>
            ...
            <section className="py-20 px-6">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-16">
                        ...
                        <h2 className="text-3xl md:text-4xl font-normal">
                            <span className="text-stone-900">Core </span>
                            <span className="italic text-blue-500">functionality</span>
                        </h2>
                    </div>
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="mb-12">
                        ...
                        <h2 className="text-3xl md:text-4xl font-normal">
                            ...
                            <span className="italic text-blue-500">stack</span>
                        </h2>
                    </div>

                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="border border-stone-200 rounded-lg p-6">
                            <h3 className="text-lg font-medium text-stone-900 mb-4">Backend</h3>
                            <div className="flex flex-wrap gap-2">
                                {techStack.backend.map((tech) => (
                                    <span key={tech} className="px-3 py-1.5 bg-stone-100 text-stone-600 rounded-full text-sm" style={{ fontFamily: 'system-ui, sans-serif' }}>
                                        {tech}
                                    </span>
                                ))}
                            </div>
                        ...
                        <div className="border border-stone-200 rounded-lg p-6">
                            <h3 className="text-lg font-medium text-stone-900 mb-4">Frontend</h3>
                            <div className="flex flex-wrap gap-2">
